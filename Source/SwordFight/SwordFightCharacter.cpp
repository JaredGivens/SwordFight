...
void ASwordFightCharacter::SetupPlayerInputComponent(
  ...
  if (UEnhancedInputComponent *EnhancedInputComponent =
    ...
    EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Started, this,
                                       &ASwordFightCharacter::Jump);
    EnhancedInputComponent->BindAction(JumpAction, ETriggerEvent::Completed,
                                       this, &ACharacter::StopJumping);

    // Moving
    EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered,
                                       this, &ASwordFightCharacter::Move);

    // Looking
    EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered,
                                       this, &ASwordFightCharacter::Look);
  } else {
    UE_LOG(
...
void ASwordFightCharacter::Move(const FInputActionValue &Value) {
  // input is a Vector2D
...
void ASwordFightCharacter::Look(const FInputActionValue &Value) {
  // input is a Vector2D
...
void ASwordFightCharacter::Jump() {
  Super::Jump();
  PlayAnimMontage(JumpAnimMontage, 1, "Default");
}
