...
UNREALROOTPATH = /home/jared/Documents/apps/UnrealEngine
GAMEPROJECTFILE =/home/jared/Documents/Unreal Projects/SwordFight/SwordFight.uproject
...
TARGETS = \
	...
	UnrealServer \
	SwordFight-Linux-Debug  \
	SwordFight-Linux-DebugGame  \
	SwordFight-Linux-Test  \
	SwordFight-Linux-Shipping  \
	SwordFight \
	SwordFightEditor-Linux-Debug  \
	SwordFightEditor-Linux-DebugGame  \
	SwordFightEditor-Linux-Test  \
	SwordFightEditor-Linux-Shipping  \
	SwordFightEditor\
	configure
...
StandardSet: RequiredTools UnrealFrontend SwordFightEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug SwordFightEditor-Linux-Debug
...
SwordFight-Linux-Debug:
	 $(PROJECTBUILD) SwordFight Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwordFight-Linux-DebugGame:
	 $(PROJECTBUILD) SwordFight Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwordFight-Linux-Test:
	 $(PROJECTBUILD) SwordFight Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwordFight-Linux-Shipping:
	 $(PROJECTBUILD) SwordFight Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwordFight:
	 $(PROJECTBUILD) SwordFight Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwordFightEditor-Linux-Debug:
	 $(PROJECTBUILD) SwordFightEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwordFightEditor-Linux-DebugGame:
	 $(PROJECTBUILD) SwordFightEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwordFightEditor-Linux-Test:
	 $(PROJECTBUILD) SwordFightEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwordFightEditor-Linux-Shipping:
	 $(PROJECTBUILD) SwordFightEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

SwordFightEditor:
	 $(PROJECTBUILD) SwordFightEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
